  ...
  return (
    <div className="flex flex-col w-full">
      <div className="relative h-[45vh] w-full border-b border-outline-ghost bg-background flex justify-center overflow-hidden">
        ...
        <img src="/banner_wide.jpg" alt="Landing" className="w-full h-full object-cover object-center grayscale-[0.5] opacity-70" />
        
        <div className="absolute bottom-12 left-0 right-0 w-full max-w-5xl mx-auto px-8 z-20">
          <h2 className="text-6xl font-display text-on-surface drop-shadow-lg tracking-normal">Landing</h2>
        </div>
      </div>
