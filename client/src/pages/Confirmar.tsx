...
const Confirmar = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="max-w-xl w-full mx-auto px-8 py-10 relative z-20 -mt-20">
        <div className="bg-surface border border-outline-ghost p-8 md:p-10 rounded shadow-2xl relative text-center flex flex-col gap-6">
